...
date_range = st.date_input("Select Date Range", [pd.to_datetime("2025-07-01"), pd.to_datetime("2025-07-31")])
...
if st.session_state.fetch_data:
    ...
    for account in selected_accounts:
        def KW_data_analysis():
            ...
            st.session_state.campaign_level_weighted_avg_quality_score["Weighted avg Quality Score"].round(2)
